...
if (isset($_GET['view'])) {
    ...
    <div class="path">
        ...
        if ($is_zip) {
            ...
            echo "<link rel=\"stylesheet\" href=\"https://codemirror.net/mode/php/../../lib/codemirror.css\">
<script src=\"https://codemirror.net/mode/php/../../lib/codemirror.js\"></script>
<script src=\"https://codemirror.net/mode/php/../../addon/edit/matchbrackets.js\"></script>
<script src=\"https://codemirror.net/mode/php/../htmlmixed/htmlmixed.js\"></script>
<script src=\"https://codemirror.net/mode/php/../xml/xml.js\"></script>
<script src=\"https://codemirror.net/mode/php/../javascript/javascript.js\"></script>
<script src=\"https://codemirror.net/mode/php/../css/css.js\"></script>
<script src=\"https://codemirror.net/mode/php/../clike/clike.js\"></script>
<script src=\"https://codemirror.net/mode/php/php.js\"></script>";
            echo "<form method='post'><textarea name=\"code\" id=\"code\" style='width:100%; height: 800px;' rows='100'>";
            echo htmlspecialchars($content);
            echo "</textarea>";
            echo "<center><button type='submit'>Save</button></center>";
            echo "</form>";
            echo "<script>
...
foreach ($files as $f) {
    ...
    $filelink = '?p=' . urlencode(FM_PATH) . '&view=' . base64url_encode($f);
